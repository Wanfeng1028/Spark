...
| v4.136 | 2026-09-26 | AI 编写：ZCode CLI·GLM-5.3-Flash（`builtin:bigmodel-start-plan/GLM-5.3-Flash`）；发起：晚风（Wanfeng1028，"参考项目中加入 ZCode"指令） | **§9 参考体系扩至 12 项：新增 #12 ZCode**（zai-org/ZCode；Apache-2.0）——状态翻案（原 §7.1/§7.3 判闭源不可参考→已开源）。详细借鉴条目待三路源码调研完成后补充。与 AGENTS v1.65、doc/01 v2.0 同批。本批纯文档零代码，本机零验证 |
