...
> 备注：工单卡细则（涉及文件、翻案 ADR 对应、批内拆分）见 doc/08 §5D；19.26 阻塞在晚风真机录制；19.34 分发步依赖证书采购；执行顺序建议按批 A→K（同批内依赖已标注）；19.43（I 批）为 2026-09-23 追加立项，不在 09-19 四项拍板内，拍板记录见 doc/08 §5D.10；19.44（J 批）为 2026-09-24 追加立项（晚风"官网不要出现这类 AI 语言，包括整个项目"指令），工单卡见 doc/08 §5D.11；19.45（沙箱四级可切换）工单行见 v4.140、未单列本表；19.46（K 批）为 2026-09-26 追加立项（晚风"对仗短句换掉 + CF 与 GH Pages 每次同步 + 域名 spark.gemmae.dev"指令），工单卡见 doc/08 §5D.12。
