...
> 备注：工单卡细则（涉及文件、翻案 ADR 对应、批内拆分）见 doc/08 §5D；19.26 阻塞在晚风真机录制；19.34 分发步依赖证书采购；执行顺序建议按批 A→I（同批内依赖已标注）；19.43（I 批）为 2026-09-23 追加立项，不在 09-19 四项拍板内，拍板记录见 doc/08 §5D.10。
