...
const ZH: UiDictionary = {
  ...
  err: {
    ...
    E_STORAGE_UNCLEANABLE: '该数据桶不可清理——可清理面仅限检查点快照、工具输出缓存、浏览器截图与回收站',
...
const EN: UiDictionary = {
  ...
  err: {
    ...
    E_STORAGE_UNCLEANABLE: 'This data bucket cannot be cleaned — cleanup is limited to checkpoint snapshots, tool output cache, browser screenshots and the trash',
