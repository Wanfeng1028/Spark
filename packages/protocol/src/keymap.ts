...
export const KEYMAP: readonly KeyBinding[] = [
  ...
  { keys: 'Esc', action: '中断当前 turn', surface: 'cli', note: 'web 为停止按钮' },
  { keys: 'y / a / n', action: '审批：允许一次 / 总是允许 / 拒绝', surface: 'cli', note: 'web 为审批卡按钮；拒绝展开理由输入' },
  { keys: 'Ctrl+O', action: '展开/折叠最近一个工具或思考条目', surface: 'cli' },
  { keys: 'Ctrl+N', action: '新建会话', surface: 'cli', note: 'web 为侧栏按钮' },
